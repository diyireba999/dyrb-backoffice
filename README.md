...
4. **New query** again → paste `supabase/002_claims.sql` → **Run**.
   Then the same for `supabase/003_accounting.sql`, `supabase/004_payroll.sql`, `supabase/005_sales.sql`, `supabase/006_categories.sql`, `supabase/007_fiuu.sql` and `supabase/008_director.sql`.
